          ...
          child: Scaffold(
            ...
            body: Column(
              children: [
                ...
                Obx(() {
                  final position =
                      controller.homeController.audioPlayer.position;
                  final duration =
                      controller.homeController.audioPlayer.duration;
                          ...
                          children: [
                            Slider(
                              ...
                              onChanged: (value) async {
                                ...
                                if (duration != null) {
                                  ...
                                  await controller.homeController.audioPlayer
                                      .seek(seekPosition);
                                }
                              },
                            ),
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  AnimatedOpacity(
                                    opacity: controller.showTimeText.value
                                        ? 1.0
                                        : 0.0,
                      ...
                      return Hero(
                        ...
                        child: IconButton(
                          ...
                          icon: Icon(
                            Icons.skip_previous,
                            color:
                                controller.homeController.currentIndex.value ==
                                    0
