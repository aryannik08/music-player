...
class _SongDetailsPageState extends State<SongDetailsPage> with SingleTickerProviderStateMixin {
  late final SongDetailsController controller;
  late final AnimationController _playPauseAnimationController;

  @override
  void initState() {
    super.initState();
    controller = Get.put(SongDetailsController());
    ...
    controller.homeController.isPlaying.listen((isPlaying) {
      if (isPlaying) {
        _playPauseAnimationController.forward();
      } else {
                            ...
                            child: SlideAnimation(
                              ...
                              child: FadeInAnimation(
                                child: IconButton(
                                  ...
                                  icon: Icon(
                                    Icons.repeat,
                                    color: controller.homeController.isRepeating.value ? theme.colorScheme.primary : null,
                                  ),
                                ),
                              ),
                            ),
                            ...
                            child: SlideAnimation(
                              ...
                              child: FadeInAnimation(
                                child: IconButton(
                                  ...
                                  icon: Icon(
                                    Icons.shuffle,
                                    color: controller.homeController.isShuffling.value ? theme.colorScheme.primary : null,
                                  ),
                                ),
                              ),
                            ),
